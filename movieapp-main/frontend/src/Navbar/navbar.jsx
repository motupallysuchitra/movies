    ...
    <a className="nav-link" href="/" style={{ color: 'white' }}>Home</a>
                    ...
                    <span className="d-flex">
                        ...
                        }
                        {
                            logged &&
                            (<>
                                <button className="btn  btn-outline-success " type="submit" onClick={myBookings} style={{border:"red"}}>My Bookings</button>
                                <button className="btn  btn-outline-success " type="submit" onClick={logout}  style={{border:"none"}}>Logout</button>
                            </>)
                        }
                    </span>
                </div>
